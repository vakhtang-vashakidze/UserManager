...
import static ge.vakhtang.um.component.utils.Constants.ADMIN_ROLE;
...
public class UMSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/health/heartbeat").hasAuthority(ADMIN_ROLE);
        ...
        http.addFilterAfter(new UMAuthorizationFilter(), UsernamePasswordAuthenticationFilter.class);
    }
